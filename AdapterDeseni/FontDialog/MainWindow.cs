...
namespace FontDialog
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void adapteYazı_Click(object sender, RoutedEventArgs e)
        {
            AdapteYazıTipi adapteYazıTipi = new AdapteYazıTipi();
            ITargetYazıTipi targetYazı = new YazıTipiAdapter(adapteYazıTipi);
