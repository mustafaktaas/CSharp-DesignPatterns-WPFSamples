...
namespace CalculatorDemo
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        GrayMode grayMode = new GrayMode();
        private void grayModeOn_Click(object sender, RoutedEventArgs e)
        {
            GrayModeOnCommand grayModeOn = new GrayModeOnCommand(grayMode);
            remoteControl.setCommand(grayModeOn);
            remoteControl.pressButton(DisplayBox,PaperBox);
        }

        private void grayModeOff_Click(object sender, RoutedEventArgs e)
        {
            GrayModeOffCommand grayModeOff = new GrayModeOffCommand(grayMode);
            remoteControl.setCommand(grayModeOff);
            remoteControl.pressButton(DisplayBox,PaperBox);
        }
    }
}